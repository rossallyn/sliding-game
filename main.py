...
background.fill(pygame.Color(colors.GRAY))
...
def draw_blocks(blocks):
    for block in blocks:
        if block['block'] != 0:
            pygame.draw.rect(window_surface, colors.WHITE, block['rect'])
            ...
            pygame.draw.rect(window_surface, colors.ORANGE, block['rect'])
